...
const safeGlobalDict = {
    ...
    "Show inline diff review controls in top level breadcrumbs or floating island": "在顶级面包屑或浮动岛中显示内联差异审查控件",
    ...
    "Show chats as editor tabs inside the chat area instead of the legacy stacked view": "在聊天区域内将聊天显示为编辑器标签页，而不是旧版堆叠视图",
    "Notifications": "通知",
    ...
    "Wait indefinitely to authenticate when prompted. When off, skip authentication prompts after 30 seconds.": "出现提示时无限期等待身份验证。关闭时，30 秒后跳过身份验证提示。",
    "Indexing & Docs": "索引与文档",
    "Cloud Agents": "云端智能体",
    "Team Plan": "团队版",
    "Plugins": "插件",
    ...
    "All commands will run without approval, classification or sandboxing.": "所有命令都将在无需批准、分类或沙盒的情况下运行。",
    ...
    "Allow Agent to switch modes without asking first, such as Agent to Plan or Agent to Debug. When off, Cursor asks before switching.": "允许智能体无需先询问即可切换模式，例如从 Agent 切换到 Plan 或 Debug。关闭时，Cursor 会在切换前询问。",
